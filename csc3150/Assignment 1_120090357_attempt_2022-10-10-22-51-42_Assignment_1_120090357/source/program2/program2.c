...
void my_wait(pid_t pid){
 ...
 wo.wo_type=type;
 wo.wo_pid=wo_pid;
 wo.wo_flags=(0|WEXITED|WUNTRACED);
 wo.wo_info=NULL;
...
int my_exec(void){
 int result;
 const char path[]="/home/vagrant/csc3150/Assignment_1_120090533/source/program2/test";
...
static int __init program2_init(void){
 ...
 printk("[program2] : module_init {Wu jingqi} {120090357}\n");
